...
This project downloads and plots administrative boundaries, water lines,
and WOPR population data for Nigeria using `ggplot2` and `sf`.

## 🛠️ Load Packages

We use `pacman::p_load` to check, install, and load all necessary
libraries.
...
![](README_files/figure-markdown_github/country-boundary-1.png)<!-- -->
...
![](README_files/figure-markdown_github/state-boundaries-1.png)<!-- -->
...
![](README_files/figure-markdown_github/water-map-1.png)<!-- -->
...
![](README_files/figure-markdown_github/final-map-1.png)<!-- -->
